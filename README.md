...
pulsar-admin functions create \
  ...
  --inputs persistent://public/default/temperature-raw \
  --output persistent://public/default/temperature-schema
```
...
pulsar-admin functions create \
  ...
  --inputs persistent://public/default/temperature-schema \
  --output persistent://public/default/temperature-processed
```
